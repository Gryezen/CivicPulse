...
class User(UserMixin, db.Model):
    ...
    # Set whenever a `pending_review` verification request is (re)submitted —
    # at initial registration, and again on POST /api/user/me/resend-verification
    # (see auth.py). Doubles as the once-per-day resend cooldown clock and as
    # a "how stale is this queue entry" signal for admin.py's review list.
    ...
    def to_dict(self):
        ...
        return {
            ...
            "verificationRequestedAt": self.verification_requested_at.isoformat() if self.verification_requested_at else None,
