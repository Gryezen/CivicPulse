 ...
 *
 * All six of these fail gracefully today (server 404s) — see the
 * repository classes under data/repository, which fall back to the same
 * local demo data the web app mocks (data/local/DemoData.kt) so the app is
 * still fully demoable. This is the one file to edit once any of them go live.
 */
